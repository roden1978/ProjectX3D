...
public class Button : Component, IInteractable, ICanvasComponent, ICanvasDrawableComponent
{
    ...
    public Rectangle Rect { get => InteractableArea;}
    ...
    public override void Draw(SpriteBatch spriteBatch)
    {
        ...
        spriteBatch.Draw(Sprite.Image, position, Sprite.Rect,
            _currentColor * _transparent, gameObject.DrawRotation.Z, origin, new Vector2(gameObject.DrawScale.X, gameObject.DrawScale.Y), SpriteEffects.None, 0);
    }
