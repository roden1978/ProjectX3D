...
public class GridLayoutGroup : Component, ICanvasComponent
{
    ...
    private IReadOnlyList<Transform> _items = [];
    ...
    private void UpdateItemsPositions()
    {
        ...
        int spriteWidth = _itemsCount > 0 ? canvasHandler.Rect.Width : 0;
        int spriteHeight = _itemsCount > 0 ? canvasHandler.Rect.Height : 0;
        ...
        for (int i = 0; i < _itemsCount; i++)
        {
            ...
            _items[i].Position = new(posX, posY, 0);
        }
